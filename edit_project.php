...
if ($_GET['status'] == 'edit') {
    $result_post = $post_edit_obj->project_edit($_GET['id']);
...
if (isset($_POST['btn'])) {
    ...
    move_uploaded_file($img_tmp, "upload/project_image/" . $img_name);
    ...
    $post_edit_change_obj->project_edit_change($_POST['name'], $_POST['description'], $_POST['status'], $img_name, $_POST['id']);
}
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" value=" Edit Project " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
