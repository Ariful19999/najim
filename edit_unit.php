...
if ($_GET['status'] == 'edit') {
    $result1 = $category_add_obj->unique_unit($_GET['id']);
}
...
if (isset($_POST['btn'])) {
    ...
    $category_add_obj->edit_unit($id, $name, $dpt_id);
}
                    ...
                    <div class="container add_post">
                        <div class="row justify-content-center">
                            <div class="col-xl-10 add_post_row">
                                <h2>Eidt Department</h2>
                                <form action="#" method="post" enctype="multipart/form-data">

                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">name</label>
                                        <div class="col-sm-10">
                                            <input required type="text" value="<?php echo $name; ?>" name="name" class="form-control" id="colFormLabel" placeholder="Enter  name" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="dpt_id" aria-label="Default select example">
                                                ...
                                                <?php while ($row = mysqli_fetch_assoc($result)) {  ?>
                                                    <tr>
                                                        <option <?php if ($dpt_id == $row['id']) echo 'selected'; ?> value="<?php echo $row['id'] ?>"><?php echo $row['name'] ?></option>
                                                    </tr>
