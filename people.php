...
$result = $post_show_obj->people_show();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="width: 80px;" class="">
                                                        <img class=" img-thumbnail" src="<?php echo $row['profile']; ?>" alt="">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="./edit_people.php?status=edit&&id=<?php echo $row['id'];  ?>" role="button">EDIT</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger" href="./delete_people.php?status=delete&&id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                                </td>
                                            </tr>
