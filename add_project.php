...
if (isset($_POST['btn'])) {
    ...
    $post_add_obj->add_project($_POST['name'], $_POST['description'], $_POST['status'], $img_name);
}
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" value=" Add Project " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
