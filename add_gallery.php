...
if (isset($_POST['btn'])) {
    ...
    move_uploaded_file($img_tmp, "upload/album_image/" . $img_name);

    //print_r($data);

    $post_add_obj->add_album($_POST['title'], $img_name);
}
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" id="colFormLabel" placeholder=" Title" />
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" value=" Add Photo " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
