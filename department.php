...
$result = $post_show_obj->department_show();
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="width: 180px;" class="">
                                                        <img class="img img-thumbnail" src="<?php echo  $row['img_url'];   ?>" alt="">
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="./edit_department.php?status=edit&&id=<?php echo $row['id'];  ?>" role="button">EDIT</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger" href="./delete_department.php?status=delete&&id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                                </td>
                                            </tr>
