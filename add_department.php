...
if (isset($_POST['btn'])) {
    ...
    $post_add_obj->add_department($_POST['name'], $_POST['code'], $_POST['cat_id'], $fileUrl);
}
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" name="name" class="form-control" id="colFormLabel" placeholder="Department Name" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Code</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="code" class="form-control" id="colFormLabel" placeholder="Enter Code" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
