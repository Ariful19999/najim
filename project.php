...
$result = $post_show_obj->project_show();
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)) {  ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="img-size">
                                                        <img class=" img-thumbnail img-fluid" src="./upload/project_image/<?php echo $row['image']; ?>" alt="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <a class="btn btn-success" href="./edit_project.php?status=edit&&id=<?php echo $row['id'];  ?>" role="button">EDIT</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger" href="./project_delete.php?status=delete&&id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                                </td>
                                            </tr>
