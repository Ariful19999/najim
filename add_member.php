...
if (isset($_POST['btn'])) {
    ...
    $post_add_obj->add_member($_POST['name'], $_POST['institute'], $_POST['designation'], $_POST['blood'], $img_name);
}
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control" id="colFormLabel" placeholder="Member Name" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Institute</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="institute" class="form-control" id="colFormLabel" placeholder="Enter Institute Name" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Designation</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="designation" class="form-control" id="colFormLabel" placeholder="Enter Your Designation" />
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" value=" Add Member " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
