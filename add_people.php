...
if (isset($_POST['btn'])) {
    ...
    $post_add_obj->add_people($_POST['name'], $_POST['email'], $_POST['phone'], $_POST['designation'], $_POST['unit_id'], $_POST['order_by'], $fileUrl);
}


$result = $post_add_obj->unit_show();
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input required type="text" name="name" class="form-control" id="colFormLabel" placeholder="People Name" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Email</label>
                                        <div class="col-sm-10">
                                            <input required type="email" name="email" class="form-control" id="colFormLabel" placeholder="Enter Your Email" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Phone</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="phone" class="form-control" id="colFormLabel" placeholder="Enter Your Mobile Number" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Designation</label>
                                        <div class="col-sm-10">
                                            <input required type="text" name="designation" class="form-control" id="colFormLabel" placeholder="Enter Your Designation" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="order_by" aria-label="Default select example">
                                                ...
                                                <option value="1">oredr-1</option>
                                                <option value="2">oredr-2</option>
                                                <option value="3">oredr-3</option>
                                                <option value="4">oredr-4</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" value=" Add People " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
