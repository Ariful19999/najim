...
if ($_GET['status'] == 'edit') {
    $result = $post_edit_obj->unique_category($_GET['id']);
}
...
if (isset($_POST['btn'])) {
    ...
    move_uploaded_file($img_tmp, "upload/blog_image/" . $img_name);
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $post_row['name'] ?>" name="name" class="form-control" id="colFormLabel" placeholder="NAME" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Blog Title</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $post_row['title'] ?>" name="title" class="form-control" id="colFormLabel" placeholder="Blog Title" />
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Blog Categories</label>
                                        <div class="col-sm-10">
                                            <select class="form-select" name="category" aria-label="Default select example">

                                                <?php while ($row = mysqli_fetch_assoc($result)) {  ?>
                                                    <option <?php if ($post_row['category'] == $row['id']) echo "selected"; ?> value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Blog Body</label>
                                        <div class="col-sm-10">
                                            <input type="text" value="<?php echo $post_row['description'] ?>" name="description" class="form-control" id="colFormLabel" placeholder="Blog Body" />
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="formFile" class="col-sm-2 col-form-label">Blog Thumbnail</label>
                                    ...
                                    <input type="submit" value=" Edit Blog " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
