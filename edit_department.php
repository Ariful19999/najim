...
if ($_GET['status'] == 'edit') {
    $result = $post_edit_obj->unique_department($_GET['id']);
}
...
$result1 = $category_add_obj->category_show();
...
if (isset($_POST['btn'])) {
    ...
    $post_add_obj->edit_department($_POST['id'], $_POST['name'], $_POST['code'], $_POST['cat_id'], $fileUrl);
}


$result = $post_add_obj->category_show();
                            ...
                            <div class="col-xl-10 add_post_row">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="colFormLabel" placeholder="Department Name" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="colFormLabel" class="col-sm-2 col-form-label">Code</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="code" value="<?php echo $code; ?>" class="form-control" id="colFormLabel" placeholder="Enter Code" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <input type="hidden" name="old_img" value="<?php echo $img_url; ?>">
                                    ...
                                    <input type="submit" value=" Edit Department " class="btn btn-success" name="btn" id="" style="margin: 13px 46px 9px 192px" />
                                </form>
                            </div>
                        </div>
                    </div>
