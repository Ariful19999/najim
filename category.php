...
$result = $post_show_obj->category_show();
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($result)) {  ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success" href="./edit_category.php?status=edit&&id=<?php echo $row['id'];  ?>" role="button">EDIT</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-danger" href="./delete_category.php?status=delete&&id=<?php echo $row['id'];  ?>" role="button">DELETE</a>
                                                </td>
                                            </tr>
